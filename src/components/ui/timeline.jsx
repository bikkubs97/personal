...
export function Timeline({ data }) {
  ...
  return (
    <div
      className="w-full bg-neutral-950 text-neutral-300 font-sans md:px-10 rounded-2xl object-cover shadow-[0_0_30px_rgba(168,85,247,0.4)]"
      ref={containerRef}
    >
      <div className="w-full mx-auto pt-16 px-4">
        <div className="flex justify-around">
          <h2 className="text-4xl max-w-4xl text-white font-bold text-center">
            About Me
          </h2>
        </div>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-2xl mb-2 text-left font-bold text-neutral-500">
                {item.title}
              </h3>
              {item.content}
            </div>

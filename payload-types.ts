...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'story-comments': StoryCommentsSelect<false> | StoryCommentsSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "story-comments".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'story-comments';
        value: number | StoryComment;
      } | null)
    | ({
        relationTo: 'media';
        value: number | Media;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "story-comments_select".
 */
export interface StoryCommentsSelect<T extends boolean = true> {
  story?: T;
  authorName?: T;
  message?: T;
  updatedAt?: T;
